      ...
      <div className="flex flex-col justify-center items-center lg:col-span-4 bg-white px-16 shadow-[-8px_0_30px_rgba(0,0,0,0.06)]">
        <div className="w-full max-w-md">
          ...
          <form className="flex flex-col gap-4">
            <div className="flex flex-col gap-1.5">
              ...
              <div className="flex items-center gap-3 border border-[#e5e7eb] bg-[#fafafa] rounded-xl px-4 py-3 focus-within:bg-white focus-within:border-violet focus-within:ring-3 focus-within:ring-violet/10 transition-all duration-200">
                <User className="w-4 h-4 text-[#c0c4cc] shrink-0" />
                <input
            ...
            <div className="flex gap-2 items-start mt-1">
              ...
              <label htmlFor="terms" className="text-sm text-text-muted cursor-pointer select-none leading-relaxed">
                I agree to the{" "}
                <a href="#" className="text-violet font-medium hover:opacity-70 transition-opacity">Terms of Service</a>
                {" "}and{" "}
                <a href="#" className="text-violet font-medium hover:opacity-70 transition-opacity">Privacy Policy</a>
              </label>
            </div>
          ...
          <p className="text-sm text-center text-text-muted mt-8">
            ...
            <Link to="/auth/login" className="text-violet font-semibold hover:opacity-70 transition-opacity">
              Sign in
            </Link>
          </p>
        </div>
